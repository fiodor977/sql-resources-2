...
UTILIZAR UN SELECT PARA METER UN VALOR CONCRETO DE OTRA TABLA

INSERT INTO CLIENTE2 (NIF, RAZON_SOCIAL, DIRECCION, POBLACION, PROVINCIA, TELEFONO, VENTAS) <br>
SELECT '123456789F', RAZON_SOCIAL, 'CALLE LA CIRUELA', 'MALAGA', 'MALAGA', '1234789', '12'<br>
FROM CLIENTE WHERE NIF = '123456789F';<br>
